...
![](https://github.com/lpyuan/AddPics/blob/master/Mass%20Shootings-2.png)
...
Instead of just marking mass shooting incidents, I added a population layer in the map and then highlight the areas of different zip codes. Moreover,I use different circle size to represent the number of injured and killed people of each mass shooting incident.  And then we can see the mass shootings happened more intensively in areas of larger population along western and eastern coast.
