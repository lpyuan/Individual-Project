...
Secondly, we rearranged the twelve datasets into one dataset with 14 columns that each country of six has its own indexes data.Here is the screenshot of the rearranged data:
