...
https://drive.google.com/drive/folders/1X8widex9lPks0oJ3ybMujDydkpUq5Uzt
...
For the raw data, each of the dataset has included all the coutries data from 1960-2016. So firstly, we have to filter out six host countries data from 1995 to 2016. 

Here is the screenshot of the raw data:
![]()

Here is the screenshot of first cleaned data:
![]()

Secondly, we rearranged the twelve datasets into one dataset with 14 columns including country name, year and twelve indexes columns.

Here is the screenshot of the rearranged data:
![]()
...
Since we have tweleve datasets, each for one of the index
...
## Summer Olympic Host Countries Analysis:

Comparing World Cup host-countries with those of the same analysis performed on countries that have hosted the Summer Olympics, a mega-event of similar magnitude.
