...
While for the revised version, I shinked the Y-axis range from 0-8 to 2-5. In this way the trend seems fluctuated remarkably, which might seem to be similiar with the original chart. It can be deceptively tell that the trend of gun death rate of homicides goes up and down, just like the original chart but had a totally different increasing trend from 3.5 in to 4.5 in 2017 which exceed the start year number.
