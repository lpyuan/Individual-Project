...
While for the revised version, I shinked the Y-axis range from 0-8 to 3-6. In this way the trend seems fluctuated remarkably, which might seem to be similiar with the original chart. It can be seen that the trend of gun death rate of homicides goes up and down, with a decline around 2007 - 2011, and goes up from 2014 - 2016, eventually exceed the start year number.
