...
Deceptive Chart: [Tableau Public Link](https://public.tableau.com/profile/lipin.yuan#!/vizhome/RateofFirearmHomicideDeaths1999-2016/Dashboard1?publish=yes)

Data Source:[CDC Multiple Cause of Death Data](https://wonder.cdc.gov/mcd.html)

Revised Version|
-------------  | 
![](https://github.com/lpyuan/AddPics/blob/master/Rate_Homicide_Deceptive_2.png.png) |
