...
From the original chart on the left, it shows that states with more guns tend to have far more gun deaths, including homicides and suicides.

Using the same data from a study in Injury Prevention and the Centers for Disease Control and Prevention, if we reverse the axis orientation, it could be visually deceptive.
